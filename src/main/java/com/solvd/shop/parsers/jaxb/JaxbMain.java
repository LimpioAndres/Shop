...
public class JaxbMain {
    ...
    public static void main(String[] args) throws JAXBException{
        ...
        OrdersParsers ordersJaxb = new OrdersParsers(6577L, 5118.5, new Date(2023-01-31), employees, 202027L);
        ordersJaxb.addClients(client);


            JAXBContext jaxbContext = JAXBContext.newInstance(OrdersParsers.class);

            //Marshall
            Marshaller marshall = jaxbContext.createMarshaller();
            marshall.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
            marshall.marshal(ordersJaxb, new File("C:/Users/gatm_/Desktop/SOLVD/shop/src/main/resources/jaxb/ordersP.xml"));
            LOGGER.info("Marshall Done");

            //Unmarshall
            Unmarshaller unmarshall = jaxbContext.createUnmarshaller();
            OrdersParsers object = (OrdersParsers) unmarshall.unmarshal(new File("C:/Users/gatm_/Desktop/SOLVD/shop/src/main/resources/jaxb/ordersP.xml"));
